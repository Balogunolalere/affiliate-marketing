...
const faqs = [
  {
    ...
    answer: "When you sign up through our affiliate link, we receive a commission from Digital BOSS Academy at no extra cost to you. This helps support our content creation while allowing you to join the program at the standard rate."
  },
  {
    question: "How long does application approval take?",
    answer: "Typically, the Digital BOSS Academy team reviews applications within 24-48 hours. The process may be faster during business days and slower on weekends or holidays."
  },
  {
    question: "What if my application is rejected?",
    answer: "Digital BOSS Academy has specific criteria for accepting new members. If your application is rejected, you can reach out to their official support team for more information or try again after addressing any potential issues."
  }
]
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "We'll forward your application details to Digital BOSS Academy.",
        variant: "default",
      })
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            ...
            >
              How to Join Through Our <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Affiliate Link</span>
            </motion.h2>
            ...
            >
              <div className="bg-secondary/50 dark:bg-secondary/30 rounded-lg p-4 border border-primary/10 shadow-inner">
                <ol className="text-left list-decimal list-inside space-y-4">
                  {[
                    "Click our affiliate link above to sign up for Digital BOSS Academy",
                    "Forward your sign-up receipt to <span class='text-primary font-medium'>helpdigitalboss@gmail.com</span>",
                    "Wait for approval from the official Digital BOSS team"
                  ].map((step, index) => (
                    <motion.li 
                      key={index}
                ...
                >
                  ...
                  <span className="text-foreground/80">
                    We are independent affiliates and cannot directly approve memberships. All approvals are handled by the official Digital BOSS Academy team.
                  </span>
                </motion.div>
              </div>
            </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 blur-3xl bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 dark:from-primary/10 dark:via-primary/20 dark:to-primary/10 -z-10 animate-pulse" />
              ...
              <CardContent className="p-6">
                <div className="mb-6 p-4 bg-secondary/60 dark:bg-secondary/40 rounded-lg border border-primary/10 shadow-inner">
                  <p className="text-sm text-foreground/80 flex items-start gap-2">
                    ...
                    <span>
                      <span className="font-semibold text-primary">Questions about the program?</span> Fill out this form and we'll help guide you through the signup process. Remember, this is an affiliate promotional site - for official support, please contact Digital BOSS Academy directly.
                    </span>
                  </p>
                </div>
