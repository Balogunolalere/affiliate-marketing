      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <h1 className="text-2xl font-bold gradient-text transition-all group-hover:opacity-90">Digital BOSS</h1>
            <motion.span 
              ...
              >
                <div className="flex flex-col space-y-3">
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      window.location.href = "https://www.skool.com/signup?ref=ae11ec21464844c6b8873e5916f8d2fa"
